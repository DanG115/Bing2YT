...
export const addCustomNavItem = () => {
  const superNav = document.getElementById(
    BING2YT_CONFIG.Edge_selectors.superNav
  );
  ...
  const navContainer = superNav.querySelector(
    BING2YT_CONFIG.Edge_selectors.navContainer
  );
  ...
  const navList = navContainer.querySelector(
    BING2YT_CONFIG.Edge_selectors.navList
  );
